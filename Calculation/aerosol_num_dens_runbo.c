...
int main()
{
	...
	int i,j,k,l,channel;
	double day;
	int wave[6]={368,500,673,778,870,940};	// detector center wavelengths
	...
	int length[11]={63,75,9,50,45,2,32,125,89,79,60};			// length of radii sub-intervals
